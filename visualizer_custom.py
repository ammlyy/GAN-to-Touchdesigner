...
class Visualizer(imgui_window.ImguiWindow):
    ...
    def draw_frame(self):
        ...
        if 'image' in self.result:
            ...
            self.gl_id = self._tex_obj.gl_id
            self.spoutSender.SendTexture(self.gl_id.item(), GL_TEXTURE_2D, self._tex_obj.width, self._tex_obj.height, False, 0)
